...
| ['a'-'z'](['A'-'Z''a'-'z''0'-'9']|"-"|"_")* as n
               { ident n }
(*(*on doit ajouter le déreferencement*)
|("*")['a'-'z'](['A'-'Z''a'-'z''0'-'9']|"-"|"_")* as ptrn   {VALEUR (String.sub ptrn 1 (String.length(ptrn)-1))}
(*ajouter l'expression d'adresse*)
|("&")['a'-'z'](['A'-'Z''a'-'z''0'-'9']|"-"|"_")* as add  {ADDRESSE (String.sub add 1 (String.length(add)-1))}*)
(* fin de lecture *)
| eof          { EOF }
(* entrée non reconnue *)
| _            { error lexbuf }
